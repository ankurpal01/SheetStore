  ...
  return (
    <div className="flex flex-col gap-10 items-center w-full print:block max-w-4xl mx-auto">
      ...
      <div className="w-full flex flex-col gap-6 print:w-full print:block mt-8 print:mt-0 print:gap-0">
        ...
        {/* Promotional Box (Outside Invoice) */}
        <div className="text-center pb-8 print:pb-0">
          <p className="text-[10px] font-bold text-slate-400 tracking-widest uppercase">
            Invoice Generated by <a href="https://sheetstore.in" className="text-slate-500 hover:text-indigo-600 transition-colors">SheetStore.in</a>
          </p>
        </div>
      </div>
